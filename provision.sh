...
sudo sshpass -p "Password1234!" scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -r /home/vsts/work/r1/a/_aconite-in.Sonic/drop/ testadmin@$vmss_ip:~/